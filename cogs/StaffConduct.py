...
a user upon receiving a **{infraction_type_name}**.",
                            ...
                            await message.edit(
                                content=f"{pendingEmoji} **{ctx.author.name},** please set the message you wish to send \
a user upon receiving a **{infraction_type_name}**." if not message_data.get('content') else message_data.get('content'),
                                embeds=[discord.Embed.from_dict(embed) for embed in message_data.get('embeds')],
                                view=view
                            )
                        await view.wait()
                        ...
                        await message.edit(
                            ...
                            embeds=[discord.Embed.from_dict(i) for i in message_data["embeds"]],
                            view=yesNoValue
                        )
